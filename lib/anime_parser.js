...
const BASE_URL = 'https://ww6.gogoanime2.org/';
const BASE_URL2 = 'https://ww22.gogoanimes.fi/';
const ajax_url = 'https://ajax.gogocdn.net/';
const anime_info_url = 'https://ww22.gogoanimes.fi/category/';
...
const seasons_url = 'https://ww22.gogoanimes.fi/sub-category/';
